...
pacman -S --noconfirm \
    ...
    fish fisher starship eza ripgrep fzf fd zoxide tealdeer pre-commit \
    go lua clang python python-pip python-virtualenv nodejs-lts-hydrogen npm pnpm jdk17-openjdk docker docker-compose bats buf \
